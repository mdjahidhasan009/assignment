const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="bg-white p-10 w-[80vw] h-[65vh] lg:w-[55vw] mt-4 rounded-lg">
        ...
        <div className="flex flex-col	justify-center items-center ">
          ...
          <button className="mt-10 py-2 px-14 bg-[#47A7FF] block w-[199px]h-[48px] text-white rounded-lg"
          >
            Sign In
          </button>
        </div>
